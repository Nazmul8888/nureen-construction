...
const Navbar = () => {
    ...
    <li><Link className=" text-black font-bold"  to='/services'>Services</Link></li>
    <li><Link className=" text-black font-bold"  to='/project'>Project</Link></li>
    ...
    return (
        <div>
            <nav className=" navbar fixed z-10 bg-opacity-30 flex items-center justify-between bg-white px-4 py-2 text-white">
    <div className="scale-100 rounded-2xl px-3 py-2 text-xl font-semibold text-white transition-all duration-200 hover:scale-110 flex gap-2">
        <img className=" w-[60px] rounded-full" src="https://i.ibb.co/FqrKX7w/depositphotos-197015732-stock-illustration-logo-swoosh-global-red-letter.webp" alt="" />
            <h1 className=" font-bold text-2xl ">Nureen <span className=" text-red-600">Construction</span></h1>
    </div>
    <ul className="flex items-center justify-between gap-6 text-slate-900">
        <li className="cursor-pointer  rounded-full  px-6 py-2 text-white hover:bg-sky-600"></li>
        {navLinks}
